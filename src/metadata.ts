...
const ogCommonMetadata: OgCommonMetadata = {
  locale: "en_US",
  type: "website",
...
const sectionCommonMeta: CommonMeta = {
  title: "Blocks",
  description:
...
const aboutPageCommonMeta: CommonMeta = {
  title: "About",
  description:
...
const careerPageCommonMeta: CommonMeta = {
  title: "Career",
  description:
...
const faqPageCommonMeta: CommonMeta = {
  title: "FAQ",
  description:
...
const pricingPageCommonMeta: CommonMeta = {
  title: "Pricing",
  description:
...
const comingSoonPageCommonMeta: CommonMeta = { title: "Coming soon", description: "Coming soon" };

const privacyPolicyCommonMeta: CommonMeta = {
...
const contactUsCommonMeta: CommonMeta = {
  title: "Contact US",
  description:
...
const error404PageCommonMeta: CommonMeta = { title: "Error 404", description: "Error 404" };
const error500PageCommonMeta: CommonMeta = { title: "Error 500", description: "Error 500" };

const underMaintenanceCommonMeta: CommonMeta = {
...
interface SeoPageContent {
  [key: string]: CommonMeta | OpenGraphMeta;
  openGraph: OpenGraphMeta;
}

interface SeoContent {
  [key: string]: SeoPageContent | CommonMeta;
  aboutPage: SeoPageContent;
  careerPage: SeoPageContent;
  faqPage: SeoPageContent;
  pricingPage: SeoPageContent;
  comingSoonPage: SeoPageContent;
  privacyPolicy: SeoPageContent;
  contactUs: SeoPageContent;
  error404Page: SeoPageContent;
  error500Page: SeoPageContent;
  underMaintenance: SeoPageContent;
}
